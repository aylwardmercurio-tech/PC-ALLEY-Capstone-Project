              ...
              >
                ...
                <form onSubmit={handleNextStep} className="space-y-6">
                  <div className="relative group">
                    ...
                    <label 
                      htmlFor="email" 
                      className="absolute left-12 -top-2.5 bg-[#080B12] px-1 text-[10px] font-black uppercase tracking-widest text-[#00F2FF] transition-all peer-placeholder-shown:top-1/2 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:text-muted peer-placeholder-shown:text-xs peer-focus:-top-2.5 peer-focus:translate-y-0 peer-focus:text-[#00F2FF] peer-focus:text-[10px]"
                    >
                      Work Email
                    </label>
                  ...
                  <button type="submit" className="w-full py-4 bg-brand-crimson hover:bg-red-700 text-main rounded-xl font-black uppercase tracking-[4px] text-xs transition-all shadow-[0_0_15px_rgba(215,38,56,0.4)] active:scale-[0.98]">
              ...
              >
                ...
                <form onSubmit={handleNextStep} className="space-y-6">
                  <div className="relative group">
                    ...
                    <label 
                      htmlFor="newPass" 
                      className="absolute left-12 -top-2.5 bg-[#080B12] px-1 text-[10px] font-black uppercase tracking-widest text-brand-neonpurple transition-all peer-placeholder-shown:top-1/2 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:text-muted peer-placeholder-shown:text-xs peer-focus:-top-2.5 peer-focus:translate-y-0 peer-focus:text-brand-neonpurple peer-focus:text-[10px]"
                    >
                      New Password
                    </label>
                  ...
                  <button type="submit" className="w-full py-4 bg-brand-neonpurple/20 border border-brand-neonpurple text-brand-neonpurple hover:bg-brand-neonpurple hover:text-main hover:shadow-[0_0_20px_rgba(188,19,254,0.5)] rounded-xl font-black uppercase tracking-[4px] text-xs transition-all active:scale-[0.98]">
                    Update Credential
                  </button>
                </form>
              </motion.div>
