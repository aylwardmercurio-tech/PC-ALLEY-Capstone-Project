...
const Breadcrumb = ({ defaultTitle }) => {
  ...
  return (
    <div className="flex flex-col">
      ...
      <h1 className="text-xl font-rajdhani font-black text-main tracking-widest uppercase flex items-center gap-3">
        <div className="w-1.5 h-1.5 rounded-full bg-brand-crimson shadow-[0_0_8px_rgba(215,38,56,0.5)]" />
        {currentTitle}
      </h1>
    </div>
  );
